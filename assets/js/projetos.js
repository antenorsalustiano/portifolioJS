function projetos(section) {
  section.innerHTML = `<header>
    ...
    <div class="content">
      <div class="cards">
        <div class="card">
          <h3>Crud .Net Dapper </h3>
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/dapper.jpg"
              alt="projeto Dapper"
            />
            <div class="buttons">
              <a href="https://github.com/antenorsalustiano/Crud-Dapper" target="_blank" title="Repositório no Github">
                <svg
          ...
          <p>
            Plataforma de estudos desenvolvido em .net Core 6 .
          </p>
          <p>.Net Core 6, C#, MVC, ORM Dapper, SqlServer</p>
        </div>
